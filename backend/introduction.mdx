...
graph TD
    ...
    Src --> App[app.js]
    Src --> Index[index.js]
    Src --> Handler[handleMessage.js]
    
    Src --> Controllers[controllers/]
    Controllers --> UC[user.controller.js]
    Controllers --> MC[messages.controller.js]
    Controllers --> CC[conversation.controller.js]
    Controllers --> TC[tasks.controller.js]
    Controllers --> OC[organization.controllers.js]
    
    Src --> Routes[routes/]
    Routes --> UR[user.routes.js]
    Routes --> MR[messages.routes.js]
    Routes --> CR[conversation.routes.js]
    Routes --> TR[tasks.routes.js]
    Routes --> OR[organization.routes.js]
    
    Src --> Middleware[middlewares/]
    Middleware --> VM[verifyUser.middleware.js]
    Middleware --> SM[verifyApiScope.middleware.js]
    Middleware --> MM[multer.middleware.js]
    Middleware --> TM[trackApiUsage.middleware.js]
    
    Src --> Utils[utils/]
    Utils --> AE[ApiError.js]
    Utils --> AR[ApiResponse.js]
    Utils --> AH[asyncHandler.js]
    Utils --> FCM[Fcm.js]
    Utils --> Sock[SocketManager.js]
    
    Src --> Model[model/]
    Model --> UM[usermodel.js]
    
    Src --> AW[appwrite/]
    AW --> AWC[appwrite.js]
    
    Public --> Docs[docs.html]
    Public --> Client[client-socket-manager.js]
    
    Config --> Env[.env]
    Config --> Pkg[package.json]
    Config --> Read[README.md]
